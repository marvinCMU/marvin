...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
default_params.usingRecommending = 0;

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% View gradient parameters
%(using during testing)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
default_params.usingViewGradients = 0;
default_params.grad_lambda = 5;
default_params.bank_l2norm = 6.8e-4;
...
default_params.train_svm_c = .0005; %% regularize more with .0001;
...
default_params.Gtraining_function = @Gsvm_update_svm;
...
init_params.auto_size_adjustment = 1;
