...
void LoadRelativeTransformData(string filename, vector<vector<int> > &vvFrame1, vector<vector<int> > &vvFrame2, vector<vector<CvMat *> > &vvM, vector<vector<CvMat *> > &vvm);
...
void SavePOI_Meanshift(string filename, vector<vector<CvMat *> > vvPOI, int nSegments_cov, vector<vector<CvMat *> > vv_a, vector<vector<CvMat*> > vv_b, vector<vector<CvMat *> > vv_l, vector<vector<double> > vvf, vector<int> vFrame, vector<vector<vector<CvMat *> > > vvvMeanTraj);
...
void SaveCameraData_KRT_AD(string filename, vector<CvMat*> cP, vector<Camera> vCamera, vector<int> vUsedFrame, int max_nFrames, vector<vector<int> > vvPointIndex);
...
void SaveStructureData_SO(string filename, vector<double> vX, vector<double> vY, vector<double> vZ,  vector<double> vX1, vector<double> vY1, vector<double> vZ1, vector<int> vR, vector<int> vG, vector<int> vB, vector<int> vID);
...
void SaveHomographyData(string filename, vector<vector<int> > vvFrame, vector<vector<CvMat *> > vvH_im2nim, vector<vector<CvMat *> > vvH_nim2nim, vector<vector<double> > vvx, vector<vector<double> > vvy, vector<vector<double> > vvx_dis, vector<vector<double> > vvy_dis, vector<vector<double> > vvScale, vector<vector<double> > vvOrientation);
void SaveHomographyData(string filename, vector<int> vID, vector<vector<int> > vvFrame, vector<vector<CvMat *> > vvH_im2nim, vector<vector<CvMat *> > vvH_nim2nim, vector<vector<double> > vvx, vector<vector<double> > vvy, vector<vector<double> > vvx_dis, vector<vector<double> > vvy_dis, vector<vector<double> > vvScale, vector<vector<double> > vvOrientation, int mode);
void SavePatchData(string filename, vector<int> vID, vector<vector<int> > vvFrame, vector<vector<double> > vvx11, vector<vector<double> > vvx12, vector<vector<double> > vvx21, vector<vector<double> > vvx22, vector<vector<double> > vvy11, vector<vector<double> > vvy12, vector<vector<double> > vvy21, vector<vector<double> > vvy22, vector<CvMat *> vX11, vector<CvMat *> vX12, vector<CvMat *> vX21, vector<CvMat *> vX22,  vector<CvMat *> vPI, vector<CvMat *> vT, int mode);
void LoadPatchData(string filename, int nStructure, vector<int> &vID, vector<vector<int> > &vvFrame, vector<vector<double> > &vvx11, vector<vector<double> > &vvx12, vector<vector<double> > &vvx21, vector<vector<double> > &vvx22, vector<vector<double> > &vvy11, vector<vector<double> > &vvy12, vector<vector<double> > &vvy21, vector<vector<double> > &vvy22, vector<CvMat *> &vX11, vector<CvMat *> &vX12, vector<CvMat *> &vX21, vector<CvMat *> &vX22,  vector<CvMat *> &vPI, vector<CvMat *> &vT);
